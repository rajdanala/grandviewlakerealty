...
Router.route("/listingdetails/:mlsId",{
	...
	data: function() {console.log(">>>>>>>>"+GrandviewListings.findOne({mlsId:'21501546'}).mlsId); return {pageContent: GrandviewListings.findOne({},{'mlsId':this.params.mlsId},{fields: {'description':1}} )}},
	waitOn: function () {
			return Meteor.subscribe('grandviewlistings')
	}
});
