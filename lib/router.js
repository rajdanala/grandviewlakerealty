FlowRouter.route('/:pageUrl',{
	name: 'home',
	action: function(params){
		console.log("This is from flow router" + params.pageUrl);
		BlazeLayout.render("layout",{content:"homePage",nav:"nav"});
	}
});

FlowRouter.route('/listing/:mlsid',{
	name: 'listing',
	action: function(params,queryParams){
		console.log("This is from flow router listingid " + params.mlsid + " "+queryParams.price );
	}
});
...
//			return Meteor.subscribe('grandviewlistings')
//	},
//	data: function () { return GrandviewListings.findOne({"_id":Router.current().params._id});}
//});
//
...
//	name:"monthlyAd",
//	waitOn: function () {
//		return Meteor.subscribe('monthlads')
//	},
//	data: function() {
//		return { monthlads:MonthlyAds.find({"name":this.params.adname,"defaultAd":true}) }
//	}
//
//});
//
